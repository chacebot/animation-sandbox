...
const WordFadeAnimation = ({ text, speed = 50 }: { text: string; speed?: number }) => {
  ...
  return (
    <span>
      {displayedText}
      {!isComplete && <span style={{ opacity: 1, animation: 'blink 1s infinite' }}>|</span>}
    </span>
  );
};
...
export const AnimationSandbox = () => {
  ...
  const animations = [
    ...
    {
      id: 'letter-reveal',
      name: 'Letter-by-Letter (Standard)',
      component: LetterRevealAnimation,
      category: 'letter',
    },
    {
      id: 'block-reveal',
      name: 'Block Reveal (Wipe)',
      component: BlockRevealAnimation,
      category: 'letter',
    },
    {
      id: 'gradient-block-reveal',
      name: 'Gradient Block Reveal',
      component: GradientBlockRevealAnimation,
      category: 'letter',
    },
    {
      id: 'colored-block-reveal',
      name: 'Colored Block Wipe',
      component: ColoredBlockRevealAnimation,
      category: 'letter',
    },
    {
      id: 'letter-fade',
      name: 'Letter-by-Letter Fade',
      component: LetterFadeAnimation,
      category: 'letter',
    },
    {
      id: 'letter-slide',
      name: 'Letter-by-Letter Slide',
      component: LetterSlideAnimation,
      category: 'letter',
    },
    {
      id: 'letter-typewriter',
      name: 'Letter-by-Letter Typewriter',
      component: LetterTypewriterAnimation,
      category: 'letter',
    },
    {
      id: 'steam-portfolio',
      name: 'Steam Portfolio Style',
      component: SteamPortfolioAnimation,
      category: 'letter',
    },
    // Other animations
    { id: 'word-fade', name: 'Word-by-Word Fade', component: WordFadeAnimation, category: 'other' },
    {
      id: 'gradient',
      name: 'Gradient Sweep',
      component: GradientRevealAnimation,
      category: 'other',
    },
    ...
    { id: 'line-reveal', name: 'Line-by-Line', component: LineRevealAnimation, category: 'other' },
    {
      id: 'stagger-fade',
      name: 'Staggered Fade',
      component: StaggerFadeAnimation,
      category: 'other',
    },
              ...
              return (
                <div
                  ...
                  style={{
                    padding: '2rem',
                    border:
                      selectedAnimation === anim.id ? '2px solid #ffffff' : '1px solid #1a1a1a',
